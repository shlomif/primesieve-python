...
cpdef uint64_t parallel_count_triplets(uint64_t a, uint64_t b = 0) except +:
    ...
    if b == 0:
        (a,b) = (0,a)
    return cpp_numpy.parallel_count_triplets(a, b)
...
cpdef void print_quadruplets(uint64_t a, uint64_t b = 0) except +:
    ...
    if b == 0:
        (a,b) = (0,a)
    cpp_numpy.print_quadruplets(a, b)
...
cpdef void print_quintuplets(uint64_t a, uint64_t b = 0) except +:
    ...
    if b == 0:
        (a,b) = (0,a)
    cpp_numpy.print_quintuplets(a, b)

cpdef void print_sextuplets(uint64_t a, uint64_t b = 0) except +:
    """Print prime sextuplets to stdout"""
    if b == 0:
        (a,b) = (0,a)
    cpp_numpy.print_sextuplets(a, b)


cdef class Iterator:
    cdef cpp_numpy.iterator _iterator
    def __cinit__(self):
        self._iterator = cpp_numpy.iterator()
